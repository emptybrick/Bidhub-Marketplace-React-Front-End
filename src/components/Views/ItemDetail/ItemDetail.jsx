      ...
      <div className="details-top">
        ...
        <div className="bid-section">
          <div className="bid-info">
            <div className="current-bid">Current Bid: ${item.current_bid}</div>
            <div className="initial-bid">Initial Bid: ${item.initial_bid}</div>
          </div>
          <div className="bid-end">
            Time left:{" "}
            <span className="time-left">
              {Math.ceil(
                (new Date(item.end_time) - new Date()) / (1000 * 60 * 60 * 24)
              )}{" "}
              days left
            </span>
          </div>
